...
class RuntimeConfigurationBehavior(unittest.TestCase):
    ...
    def runs_runtime(self, *arguments: str) -> subprocess.CompletedProcess[str]:
    ...
    def test_uses_cli_project_over_dotenv(self) -> None:
        ...
        result = self.runs_runtime("--repo", str(other_project))
